\classheader{Warrior}{
    ...
    \textbf{Attack modifier}: Warriors use a ``deed die'' instead of an attack modifier. The warrior rolls this die on each attack and applies it to both their chance to hit and their damage. \\
    ...
    \textbf{Initiative}: A warrior adds their class level to their initiative rolls.\\
