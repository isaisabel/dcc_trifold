\classheader{Wizard}{
    ...
    \textbf{Spellburn}: Wizards may sacrifice ability scores for bonuses to spell checks. For every ability point they expend, the wizard adds +1 to their spell check. Ability scores lost in this way return at a rate of 1 per day that spellburn has not been inflicted. Other sacrifices can also net casting bonuses, at a rate of +1 per 500gp. \\
    ...
    \textbf{Corruption}: Low-level wizards are powerful. High-level wizards fear for their souls. Natural 1s on spell checks can result in misfire and/or corruption. Corruption effects are permanent but modified by the wizard's luck score.\\
}
