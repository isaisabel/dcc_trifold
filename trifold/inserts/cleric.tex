\classheader{Cleric}{
    ...
    \textbf{Weapon training}: A cleric is trained to use weapons used by faithful followers of their god. Clerics may use armor and spell checks are not hindered by its use. \\
